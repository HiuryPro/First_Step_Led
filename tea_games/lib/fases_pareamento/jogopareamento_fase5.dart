...
class JogoPareamentoFase5 extends StatefulWidget {
  const JogoPareamentoFase5({super.key});

  @override
  State<JogoPareamentoFase5> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<JogoPareamentoFase5> {
                          ...
                          onTap: () async {
                            if (primeiraCartaSelecionada == -1 ||
                              ...
                              if (!listaColor.contains(null)) {
                                ...
                                await crud.update(
                                    query:
                                        'Update fases_pareamento set FASE_5 = 1 where ID_USUARIO = $id',
                                    lista: []);
