...
class JogoMemoriaFase6 extends StatefulWidget {
  const JogoMemoriaFase6({super.key, required this.title});
  final String title;

  @override
  State<JogoMemoriaFase6> createState() => _JogoMemoriaFase6State();
}

class _JogoMemoriaFase6State extends State<JogoMemoriaFase6> {
  bool visivel = true;
  int fase = 6;
                        ...
                        back: GestureDetector(
                          onTap: () async {
                            if (primeiraCartaSelecionada == -1 ||
                              ...
                              await crud.update(
                                  query:
                                      'Update fases_memoria set FASE_6 = 1 where ID_USUARIO = $id',
                                  lista: []);
